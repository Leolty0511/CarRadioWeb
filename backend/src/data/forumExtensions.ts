...
export const FORUM_EXTENSIONS: ForumExtensionMeta[] = [
  ...
  { id: 'fof-passport', name: 'Passport', nameZh: '主站账号登录', description: 'Connect Flarum to an external OAuth 2.0 account provider.', descriptionZh: '通过 OAuth 2.0 使用主站会员账号登录论坛。', developer: 'Friends of Flarum', composerPackage: 'fof/passport' },
