...
export const commonRoutes: RouteConfig[] = [
  ...
  // 扫码查阅入口：与知识库/说明书同一套页面，无需注册登录
  { path: 'guide', component: KnowledgeLanding },
  { path: 'guide/vehicle-data', component: VehicleData },
  { path: 'guide/video-tutorials', component: VideoTutorials },
  { path: 'guide/device-operation-videos', component: DeviceOperationVideoTutorials },
  { path: 'guide/tutorials', component: Tutorials },
  { path: 'guide/canbus-settings', component: CANBusSettings },
  { path: 'guide/user-manual', component: UserManual },
  { path: 'guide/user-manual/:slug', component: UserManualDetail },
  { path: 'guide/:type/:id', component: DocumentDetail },
